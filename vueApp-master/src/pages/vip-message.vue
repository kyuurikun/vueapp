    ...
    <div class="vippage-container">      
        <div class="user-detail">        
            ...
            <div class="user-detail__message">
                 <p class="user_name">昵称：{{uInfs.user_name}}</p>
            </div>
        ...
        <div class="order-status-container">
            <ul>
                <li classs="order-status order-status--unpay">
                    <a>
                        <div class="iconfont icon-wuliu2"><span>0</span></div>
                        <p>待付款</p>
                    </a>
                </li>
        ...
        <div class="operate">
            <div class="operate__list all-order">
                <a>
                    <router-link tag="订单" to="/orders"><span class="iconfont icon-dingdan">全部订单</span></router-link>
            ...
            <div class="operate__list shopping-help">
             ...
             <div class="operate__list concern-us">
            	 <a>              
                    <span @click="See('http://weibo.com/zhengzhinanshen')" class="iconfont icon-guanzhu">关注我们</span>
                    <strong class="iconfont icon-icon"></strong>
                </a>
            </div>          
        </div>
            ...
            <transition name="slide">
                 <v-touch tag="div" v-on:swipeleft="hideSilde" class="other-set" v-show="isShow">                    
                        ...
                        <ul>
                            <router-link :to ='{name:"paypwd"}' ><li class="iconfont icon-set">修改支付密码</li></router-link>
                            <router-link :to ='{name:"ChangePwd"}' ><li class="iconfont icon-set">修改密码</li></router-link>
                            <a @click="logout"><li class="iconfont icon-set">退出登录</li></a>
                        </ul>
                 </v-touch>           
            </transition>
